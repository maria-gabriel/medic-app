...
import java.util.List;
    ...
    //Ventana para visualizacón de citas de los médicos
public class Admin5 extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener{
    String Lid,Lname,Lname2,Lname3,Lemail,Lpass1,Lm,Lp;
    RequestQueue rq;
    JsonRequest jrq;
    TextView result,t1,t2,t3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.admin5);
        ...
        new Enviar(Admin5.this).execute();
        String IP = getString(R.string.ip);
        //Manda petición para obtener datos de la base de datos
        String url = "http://"+IP+"/android/reporte.php";
    ...
    //Función para insertar el total de las citas de los médicos
    public boolean Insertar(){
        ...
        String IP = getString(R.string.ip);
        httpPost = new HttpPost("http://"+IP+"/android/reporte1.php");
    ...
    public void onResponse(JSONObject response) {
        ...
        try{
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Lpass1 = jsonObject.optString("TotalCitas");
                Lm = jsonObject.optString("Medicos");
                Lp = jsonObject.optString("Pacientes");
                int x,x2,x3;
                x= Integer.parseInt(Lm);
                x2= Integer.parseInt(Lp);
                x3=x+x2;
                t1.setText("Total de usuarios: "+String.valueOf(x3));
                t2.setText("Médicos: "+Lm);
                t3.setText("Pacientes: "+ Lp);
                result.append("\nID Médico: "+Lid+"\n"+"Nombre: "+Lname+" "+Lname2+" "+Lname3+"\nCorreo: "+Lemail+
                        "\nTotal de citas: " + Lpass1);
