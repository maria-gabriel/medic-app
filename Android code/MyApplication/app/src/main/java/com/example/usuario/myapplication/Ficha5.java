...
import org.json.JSONObject;
    ...
    //Ventana para ver observaciones médicas para el médico
public class Ficha5 extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener{
    TextView txt;
    RequestQueue rq;
    JsonRequest jrq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ficha5);
